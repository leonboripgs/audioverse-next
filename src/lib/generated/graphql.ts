...
export type CardSongFragment = {
	...
	sequence: Maybe<{ __typename?: 'Sequence'; id: string; title: string }>;
	audioFiles: Array<{
		__typename?: 'AudioFile';
		url: string;
		filesize: string;
...
export type RecordingFragment = {
	...
	sponsor: Maybe<{ __typename?: 'Sponsor'; title: string; id: string }>;
	sequence: Maybe<{
		__typename?: 'Sequence';
		id: string;
		title: string;
...
export type GetPresenterDetailPathsDataQuery = {
	...
	persons: {
		__typename?: 'PersonConnection';
		nodes: Maybe<Array<{ __typename?: 'Person'; id: string }>>;
	};
};
...
export type GetSongDetailTagPathsDataQuery = {
	...
	musicMoodTags: {
		__typename?: 'TagConnection';
		nodes: Maybe<Array<{ __typename?: 'Tag'; name: string }>>;
	};
};
...
>(
	...
	useQuery<GetConferenceDetailPageDataQuery, TError, TData>(
		...
		graphqlFetcher<
			...
			GetConferenceDetailPageDataQueryVariables
		>(GetConferenceDetailPageDataDocument, variables),
		options
	);
...
>(
	...
	useQuery<GetConferenceDetailPathsDataQuery, TError, TData>(
		...
		graphqlFetcher<
			GetConferenceDetailPathsDataQuery,
			GetConferenceDetailPathsDataQueryVariables
		>(GetConferenceDetailPathsDataDocument, variables),
		options
	);
...
>(
	...
	useQuery<GetConferenceListPageDataQuery, TError, TData>(
		...
		graphqlFetcher<
			...
			GetConferenceListPageDataQueryVariables
		>(GetConferenceListPageDataDocument, variables),
		options
	);
...
>(
	...
	useQuery<GetConferenceListPathsDataQuery, TError, TData>(
		...
		graphqlFetcher<
			GetConferenceListPathsDataQuery,
			GetConferenceListPathsDataQueryVariables
		>(GetConferenceListPathsDataDocument, variables),
		options
	);
...
>(
	...
	useQuery<GetSongAlbumPageDataQuery, TError, TData>(
		...
		graphqlFetcher<
			GetSongAlbumPageDataQuery,
			GetSongAlbumPageDataQueryVariables
		>(GetSongAlbumPageDataDocument, variables),
		options
	);
...
>(
	...
	useQuery<GetSongAlbumPathsDataQuery, TError, TData>(
		...
		graphqlFetcher<
			GetSongAlbumPathsDataQuery,
			GetSongAlbumPathsDataQueryVariables
		>(GetSongAlbumPathsDataDocument, variables),
		options
	);
...
>(
	...
	useQuery<GetSongBookPageDataQuery, TError, TData>(
		...
		graphqlFetcher<GetSongBookPageDataQuery, GetSongBookPageDataQueryVariables>(
			GetSongBookPageDataDocument,
			variables
		),
		options
	);
...
>(
	...
	useQuery<GetSongSponsorPageDataQuery, TError, TData>(
		...
		graphqlFetcher<
			GetSongSponsorPageDataQuery,
			GetSongSponsorPageDataQueryVariables
		>(GetSongSponsorPageDataDocument, variables),
		options
	);
...
>(
	...
	useQuery<GetSongSponsorPathsDataQuery, TError, TData>(
		...
		graphqlFetcher<
			GetSongSponsorPathsDataQuery,
			GetSongSponsorPathsDataQueryVariables
		>(GetSongSponsorPathsDataDocument, variables),
		options
	);
...
>(
	...
	useQuery<GetSongDetailTagPageDataQuery, TError, TData>(
		...
		graphqlFetcher<
			GetSongDetailTagPageDataQuery,
			GetSongDetailTagPageDataQueryVariables
		>(GetSongDetailTagPageDataDocument, variables),
		options
	);
...
>(
	...
	useQuery<GetSongDetailTagPathsDataQuery, TError, TData>(
		...
		graphqlFetcher<
			GetSongDetailTagPathsDataQuery,
			GetSongDetailTagPathsDataQueryVariables
		>(GetSongDetailTagPathsDataDocument, variables),
		options
	);
...
>(
	...
	useQuery<GetSongsListPageDataQuery, TError, TData>(
		...
		graphqlFetcher<
			GetSongsListPageDataQuery,
			GetSongsListPageDataQueryVariables
		>(GetSongsListPageDataDocument, variables),
		options
	);
...
>(
	...
	useQuery<GetSponsorAlbumsPageDataQuery, TError, TData>(
		...
		graphqlFetcher<
			...
			GetSponsorAlbumsPageDataQueryVariables
		>(GetSponsorAlbumsPageDataDocument, variables),
		options
	);
...
>(
	...
	useQuery<GetSponsorAlbumsPathsDataQuery, TError, TData>(
		...
		graphqlFetcher<
			GetSponsorAlbumsPathsDataQuery,
			GetSponsorAlbumsPathsDataQueryVariables
		>(GetSponsorAlbumsPathsDataDocument, variables),
		options
	);
...
>(
	...
	useQuery<GetSponsorBooksPageDataQuery, TError, TData>(
		...
		graphqlFetcher<
			...
			GetSponsorBooksPageDataQueryVariables
		>(GetSponsorBooksPageDataDocument, variables),
		options
	);
...
>(
	...
	useQuery<GetSponsorBooksPathsDataQuery, TError, TData>(
		...
		graphqlFetcher<
			GetSponsorBooksPathsDataQuery,
			GetSponsorBooksPathsDataQueryVariables
		>(GetSponsorBooksPathsDataDocument, variables),
		options
	);
...
>(
	...
	useQuery<GetStoriesPageDataQuery, TError, TData>(
		...
		graphqlFetcher<GetStoriesPageDataQuery, GetStoriesPageDataQueryVariables>(
...
>(
	...
	useQuery<GetStoriesPathDataQuery, TError, TData>(
		...
		graphqlFetcher<GetStoriesPathDataQuery, GetStoriesPathDataQueryVariables>(
...
>(
	...
	useQuery<GetStoryDetailPageDataQuery, TError, TData>(
		...
		graphqlFetcher<
			GetStoryDetailPageDataQuery,
			GetStoryDetailPageDataQueryVariables
		>(GetStoryDetailPageDataDocument, variables),
		options
	);
...
>(
	...
	useQuery<GetStoryDetailPathsDataQuery, TError, TData>(
		...
		graphqlFetcher<
			GetStoryDetailPathsDataQuery,
			GetStoryDetailPathsDataQueryVariables
		>(GetStoryDetailPathsDataDocument, variables),
		options
	);
...
>(
	...
	useQuery<GetTagDetailPageDataQuery, TError, TData>(
		...
		graphqlFetcher<
			...
			GetTagDetailPageDataQueryVariables
		>(GetTagDetailPageDataDocument, variables),
		options
	);
...
>(
	...
	useQuery<GetTagDetailPathsQueryQuery, TError, TData>(
		...
		graphqlFetcher<
			GetTagDetailPathsQueryQuery,
			GetTagDetailPathsQueryQueryVariables
		>(GetTagDetailPathsQueryDocument, variables),
		options
	);
...
>(
	...
	useQuery<GetTagListPageDataQuery, TError, TData>(
		...
		graphqlFetcher<GetTagListPageDataQuery, GetTagListPageDataQueryVariables>(
...
>(
	...
	useQuery<GetTagListPathsDataQuery, TError, TData>(
		...
		graphqlFetcher<GetTagListPathsDataQuery, GetTagListPathsDataQueryVariables>(
